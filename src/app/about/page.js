            ...
            <div className="row">
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-12 p-xl-5 p-lg-5 p-md-3 p-0">
                    <div className="about-content  mt-xl-5 mt-lg-5 mt-md-5">
                        <div className="content mt-xl-5  mt-md-5">
                            <h2 className="about-head mt-xl-3 mt-lg-3 mt-md-5 ">Who We Are</h2>
                            <p className="about-para mt-xl-4">At Beeyoond Gaming, a proud Sportstech Venture, we bring ideas to life through powerful 2D/3D animation, immersive game development, and cutting-edge virtual experiences.<br/>From eye-catching visuals to treadmill-integrated gameplay, we craft fun, exciting, and unforgettable digital worlds. Whether it's a game, a cinematic video, or an interactive virtual adventure — if it’s creative and experiential, we make it real.
